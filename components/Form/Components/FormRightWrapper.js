...
const projectId = '2H5JMftnmhvo1mlszt8TfPJtAaf'
const projectSecret = 'fecede88ed97c78bcdaf5f81a390e5f6'
  ...
  return (
    <FormRight>
        <FormInput>
            <FormRow>
                <RowFirstInput>
                    ...
                    <Input onChange={Handler.FormHandler} value={Handler.form.requiredAmount} type={'number'} placeholder='Required Amount' name='requiredAmount'></Input>
                </RowFirstInput>
                <RowSecondInput>
        ...
        {uploadLoading == true ? <Button><TailSpin color='#fff' height={20}/></Button>:
            ...
            : <Button style={{cursor: "no-drop"}}>Files uploaded succesfully</Button>
        }
...
const Button = styled.button`
    ...
    background-image: linear-gradient(180deg, #1E1E1E, #1E1E1E 80%);
    border: none;
    margin-top: 30px;
    cursor: pointer;
    font-weight: bold;
